        ...
        <div class="page-index">
            ...
            <div class="banner">
                <div class="ball-content">
                    <div class="ball">
                        <div class="img ball-1"></div>
                        <div class="img ball-2"></div>
                        <div class="img ball-3"></div>
                        <div class="img ball-4"></div>
                        <div class="img ball-5"></div>
                    </div>
                </div>
                <h3>
                    <p>为用户创造更多价值，推动构建互联网、物联网的生态市场</p>
                    <p>上海崆苍网络科技有限公司</p>
                </h3>
                <div class="btn">关于我们></div>
                <div class="city">
